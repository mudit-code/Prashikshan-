      ...
      <section className="relative min-h-screen flex items-center justify-center bg-[#F5F5DC] text-gray-900 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            >
              <FaRocket className="text-6xl md:text-8xl text-[#4A3728]" />
            </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/login" className="btn-secondary border-gray-900 text-gray-900 hover:bg-gray-900/5 text-lg px-8 py-4">
                Login
              </Link>
            </div>
          </motion.div>
